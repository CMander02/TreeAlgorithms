...
int main()
{
    ...
    // Read datasets
    std::ifstream file10("data_10.txt"); // Replace with your file name
    ...
    std::ifstream file100("data_100.txt"); // Replace with your file name
    ...
    std::ifstream file1000("data_1000.txt"); // Replace with your file name
    ...
    std::ifstream file10000("data_10000.txt"); // Replace with your file name
    ...
    std::ifstream file100000("data_100000.txt"); // Replace with your file name
    ...
    std::ifstream file1000000("data_100000.txt"); // Replace with your file name
    std::vector<int> numbers_1000000;

    if (file1000000.is_open())
    {
        while (getline(file1000000, line))
        {
            // Convert line to int and add to vector
            numbers_1000000.push_back(stoi(line));
        }
        file1000000.close();
    }
    else
    ...
    std::ifstream file10000000("data_100000.txt"); // Replace with your file name
    std::vector<int> numbers_10000000;

    if (file10000000.is_open())
    {
        while (getline(file10000000, line))
        {
            // Convert line to int and add to vector
            numbers_10000000.push_back(stoi(line));
        }
        file10000000.close();
    }
    else
    ...
    //  insert from datasets
    start = std::chrono::steady_clock::now();
    AVLTree<int> tree1000000;
    for (int num : numbers_1000000)
    {
        tree1000000.insert(num);
    }
    stop = std::chrono::steady_clock::now();
    difference_in_time = stop - start;
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken to build AVL tree with 1000000 nodes is : " << difference_in_seconds << " seconds" << endl;

    // search
    // get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();

    tree1000000.search(numbers_1000000[7]);
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by AVL search with 1000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    // maximum
    //  get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by AVL maximum with 1000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    // minimum
    //  get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by AVL minimum with 1000000 nodes is : " << difference_in_seconds << " seconds" << endl;

    // Tree10000000
    //  insert from datasets
    start = std::chrono::steady_clock::now();
    AVLTree<int> tree10000000;
    for (int num : numbers_10000000)
    {
        tree10000000.insert(num);
    }
    stop = std::chrono::steady_clock::now();
    difference_in_time = stop - start;
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken to build AVL tree with 10000000 nodes is : " << difference_in_seconds << " seconds" << endl;

    // search
    // get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();

    tree10000000.search(numbers_10000000[7]);
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by AVL search with 10000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    // maximum
    //  get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();

    tree10000000.maximum();
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by AVL minimum with 10000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    ...
    //  insert from datasets
    start = std::chrono::steady_clock::now();
    RBTree<int> treeRB1000000;
    for (int num : numbers_1000000)
    {
        treeRB1000000.insert(num);
    }
    stop = std::chrono::steady_clock::now();
    difference_in_time = stop - start;
    // change to seconds
    ...
    treeRB1000000.search(numbers_1000000[7]);
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by RB search with 1000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    // maximum
    //  get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();

    treeRB1000000.maximum();
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by RB maximum with 1000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    // minimum
    //  get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();

    treeRB1000000.minimum();
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by RB minimum with 1000000 nodes is : " << difference_in_seconds << " seconds" << endl;

    // treeRB10000000
    //  insert from datasets
    start = std::chrono::steady_clock::now();
    RBTree<int> treeRB10000000;
    for (int num : numbers_10000000)
    {
        treeRB10000000.insert(num);
    }
    stop = std::chrono::steady_clock::now();
    difference_in_time = stop - start;
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken to build RB tree with 10000000 nodes is : " << difference_in_seconds << " seconds" << endl;

    // search
    // get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();

    treeRB10000000.search(numbers_10000000[7]);
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by RB search with 10000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    // maximum
    //  get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();

    treeRB10000000.maximum();
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by RB maximum with 10000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    // minimum
    //  get a start time. insert this line where you want the time measurement begins.
    start = std::chrono::steady_clock::now();

    treeRB10000000.minimum();
    ...
    // change to seconds
    difference_in_seconds = double(difference_in_time.count());
    cout << "Time taken by RB minimum with 10000000 nodes is : " << difference_in_seconds << " seconds" << endl;
    /*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
